"""
2026-06-04 경기 open/close BM 배당 수집
match_ids: KUxtpMSI, zJlGoZ3N, pAgiiwzn, Aonqhgqt, vie7meZA
winner/score는 추후 업데이트
"""
            ...
            for bm in POPUP_BMS:
                ...
                if mask.any():
                    ...
                    new_rows.append({
                        ...
                        'winner_direction':None,'odds_ratio':odds_ratio,'consensus':consensus,
                    })
                    updated += 1
                time.sleep(0.4)
