"""
2026-06-03 경기 open/close BM 배당 수집 (slot 2~5)
slot1 Doosan-Hanwha: 3-3 미완료(우천중단 추정) → 제외
match_ids: O2qXorb6, Q71penyK, jkoPm4Tg, djhGkQbs
"""
...
MATCHES = [
    {'match_id':'O2qXorb6','slot':2.0,'home':'KIA Tigers','away':'Lotte Giants',
     'winner':'Lotte Giants','winner_is_home':False,'home_score':3,'away_score':8,
     'url':'https://www.oddsportal.com/baseball/south-korea/kbo/kia-tigers-lotte-giants-O2qXorb6/#home-away;2'},
    {'match_id':'Q71penyK','slot':3.0,'home':'SSG Landers','away':'Kiwoom Heroes',
     'winner':'SSG Landers','winner_is_home':True,'home_score':5,'away_score':4,
     'url':'https://www.oddsportal.com/baseball/south-korea/kbo/ssg-landers-kiwoom-heroes-Q71penyK/#home-away;2'},
    {'match_id':'jkoPm4Tg','slot':4.0,'home':'KT Wiz Suwon','away':'LG Twins',
     'winner':'KT Wiz Suwon','winner_is_home':True,'home_score':7,'away_score':6,
     'url':'https://www.oddsportal.com/baseball/south-korea/kbo/kt-wiz-suwon-lg-twins-jkoPm4Tg/#home-away;2'},
    {'match_id':'djhGkQbs','slot':5.0,'home':'Samsung Lions','away':'NC Dinos',
     'winner':'NC Dinos','winner_is_home':False,'home_score':4,'away_score':6,
     'url':'https://www.oddsportal.com/baseball/south-korea/kbo/samsung-lions-nc-dinos-djhGkQbs/#home-away;2'},
]
